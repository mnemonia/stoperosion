...
export class SettingsService {
  ...
  constructor(private dbService: DatabaseService) {
    ...
    const res = this.dbService.findAll();
    if (res.length === 0) {
      ...
      for (let index = 0; index < this.anzahl_jahre; index++) {
        const b = new BewirtschaftungProJahr(index + 1);
        b.hauptnutzungKultur = defaultKultur;
        b.hauptnutzungBodenbearbeitung = defautBodenbearbeitung;
        b.zwischennutzungKultur = defaultKultur;
        b.zwischennutzungBodenbearbeitung = defautBodenbearbeitung;
        nf.bewirtschaftung_pro_jahr.push(b);
      }
      ...
      res.forEach(bew => this.bewirtschaftungseinheiten.push(bew));
    }
  ...
  public save() {
    this.dbService.saveAll(this.bewirtschaftungseinheiten);
  }
}
